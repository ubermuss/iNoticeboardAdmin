...
class Lostxfound extends databaseObject {
protected static $tablename = "lostxfound";
protected static $db_fields = array('LF_ID','Title','Description','Contacts','photo','type','size');
public $LF_ID;
public $Title;
public $photo;
public $type;
...
public $Description;
private $tmp_path;
protected $upload_dir = "lostxfound";
public $errors = array();
...
public function save () {
	...
	// basically the Title
		...
		// error 2: Make sure the Title is not long
		...
		$target_path= SITE_ROOT.DS.'public'.DS.$this->upload_dir.DS.$this->photo;
		// error 4: check if file exists
		if(file_exists($target_path)){
		$this->errors [] = "The file <b>{$this->photo}</b> already exists";
		return false;
		}
		// moving the file
...
public function image_path(){
	return $this->upload_dir.DS.$this->photo; 
}
