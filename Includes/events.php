...
protected static $db_fields = array('E_ID','Title','poster','type','size','Location','Price','Date','Contacts','Extras','Description','Theme');
public $E_ID;
public $Title;
public $poster;
public $type;
...
public function save () {
	...
	// basically the Title
		...
		if(empty($this->poster) || empty($this->tmp_path)){
		...
		$this->errors [] = "The file <b>{$this->poster}</b> already exists";
		return false;
		}
		// moving the file
...
public function image_path(){
	return $this->upload_dir.DS.$this->poster; 
}
