...
$sql = "SELECT * FROM news WHERE F_ID=1 ORDER BY N_ID DESC";
$counter = 1;
  ...
  <body>
    <div class="navmenu navmenu-default navmenu-side navmenu-fixed-left offcanvas-sm">
      ...
      <ul class="nav navmenu-nav">
        <li class="active withripple"><a href="facultyNews.php">News</a></li>
    ...
    <div class="row">
      <div class="col-md-6">
         <p>Hi! <?php echo $name ?>, Post news to inoticeboard app</p>
          <form class="form-hor0izontal inner-form" method="POST" action="facultyNews.php">
  <fieldset>
